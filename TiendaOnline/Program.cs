...
Utilities.ShoppingCartAPIBase = 
    builder.Configuration["ServiceUrls:ShoppingCartAPI"];
...
builder.Services.AddScoped<ICouponService, CouponServcie>();
builder.Services.AddScoped<IProductService, ProductService>();
builder.Services.AddScoped<ICartService, CartService>();
builder.Services.AddScoped<IOrderService, OrderService>();
//podemos subir archivos atraves del services
